...
\newcommand{\studentfullname}{TODO}
\newcommand{\studentemail}{TODO}  % Only relevant for term papers, ignored for bachelor's and master's theses
\newcommand{\studentID}{TODO}

\newcommand{\manuscripttitle}{TODO}

\newcommand{\manuscriptdate}{TODO}  % TODO: use ISO format yyyy-mm-dd
...
\input{sections/04_simulation_design}
...
\input{appendix/appendix_full_results}
\input{appendix/appendix_power}
\input{appendix/appendix_boundary}
\input{appendix/appendix_coverage}
\input{appendix/appendix_profiles}
